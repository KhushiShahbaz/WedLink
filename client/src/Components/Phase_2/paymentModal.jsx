          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-6">
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-4 rounded-xl border-2 focus:outline-none focus:ring-2 transition-all duration-200 ${
                      errors.amount ? 'border-red-300 bg-red-50 dark:border-red-600 dark:bg-red-900' : 'border-gray-200 focus:ring-purple-500 dark:border-gray-700 dark:focus:ring-purple-500'
                    }`}
                ...
                <div className="mt-4">
                  <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">Quick Select:</p>
                  <div className="flex flex-wrap gap-2">
                    {predefinedAmounts.map((preset) => (
                      <motion.button
                        ...
                        className="px-4 py-2 bg-gray-100 hover:bg-purple-100 text-gray-700 hover:text-purple-700 dark:bg-gray-700 dark:hover:bg-purple-700 dark:text-gray-300 dark:hover:text-white rounded-lg text-sm font-medium transition-all duration-200"
                      >
                        ₹{preset}
                      </motion.button>
                    ))}
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-4 rounded-xl border-2 focus:outline-none focus:ring-2 transition-all duration-200 resize-none ${
                    errors.description ? 'border-red-300 bg-red-50 dark:border-red-600 dark:bg-red-900' : 'border-gray-200 focus:ring-purple-500 dark:border-gray-700 dark:focus:ring-purple-500'
                  }`}
              ...
              {/* Payment Features */}
              <div className="mb-6 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900 dark:to-pink-900 rounded-2xl p-4 border border-purple-100 dark:border-gray-700">
                <div className="flex items-center space-x-3 mb-3">
                  <FiCreditCard className="w-5 h-5 text-purple-600 dark:text-purple-400" />
                  <h3 className="font-semibold text-purple-800 dark:text-purple-200">Payment Features</h3>
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={onClose}
                  className="flex-1 px-6 py-3 border-2 border-gray-200 text-gray-700 dark:border-gray-700 dark:text-gray-300 rounded-xl font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200"
                >
                  Cancel
                </motion.button>
                <motion.button
